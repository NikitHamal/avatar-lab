...
import { useStudioLanguage, type StudioLanguage } from '@/i18n'
import type { StudioController } from '@/features/studio/useStudioController'

type StudioIdentityProps = Partial<Pick<StudioController, 'language' | 'setLanguage' | 't'>> & {
  className?: string
}
...
export function StudioIdentity({
  ...
  const i18n = useStudioLanguage()
  const language = propLanguage ?? i18n.language
  const setLanguage = propSetLanguage ?? i18n.setLanguage
